...
C:\ProgramFiles\JetBrains\javaagent.jar

修改配置文件

C:\ProgramFiles\JetBrains\IntelliJ IDEA 2016.3.8\bin\idea.exe.vmoptions

添加配置内容

-javaagent:C:\ProgramFiles\JetBrains\javaagent.jar
